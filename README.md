...
Metric of success: reduce clicks from 4 → 1
...
{AI}Used ChatGPT (GPT-5.1) to generate layout ideas, rewrite CSS, and assist in try/catch implementation.
